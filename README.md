...
开发中的桌面化 Kiro 注册工作台，聚焦三件事：

> 当前仓库仅供学习、研究和本地技术验证使用，禁止用于任何商业用途。
>
> 项目仍处于开发阶段，功能、接口和真实链路结果都可能继续调整。
>
> 欢迎社区在学习与研究前提下通过 Issue、讨论和 Pull Request 共同改进本项目。
...
- 本项目当前定位为学习型、实验型桌面工作台
- 仅供个人学习、接口研究、流程验证与本地开发调试使用
- 禁止将本项目用于商业用途、对外收费服务或生产环境运营
- 欢迎社区以学习研究为前提参与共建、反馈问题与提交改进
- 使用者应自行确认相关平台条款、法律法规与账号风险
